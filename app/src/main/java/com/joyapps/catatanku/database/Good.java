...
public class Good {
    ...
    public Good(int goodId, String goodName, int goodQty, String goodQuality, int goodPrice) {
        this.goodId = goodId;
    ...
    @Ignore
    public Good(String goodName, int goodQty, String goodQuality, int goodPrice) {
        this.goodName = goodName;
        this.goodQty = goodQty;
        this.goodQuality = goodQuality;
        this.goodPrice = goodPrice;
